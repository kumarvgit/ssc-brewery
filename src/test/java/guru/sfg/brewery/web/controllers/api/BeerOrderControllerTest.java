...
class BeerOrderControllerTest extends BaseIT {
    ...
    // TODO find whats going wrong in thi particular method if the name is setup
    @BeforeEach
    ...
    @WithUserDetails("spring") // will go and look for user details service, this is provided by spring security test
    @Test
